...
urlpatterns = [
    ...
    path('add-new-password/<str:token>/', views.AddNewPassword.as_view(), name="add-new-password"),
    path('add-new-password/', views.AddNewPassword.as_view(), name="add-new-password"),
    ...
    path('team/<int:id>/', views.team_view, name='team-view'),
    path('team/delete/<int:id>/', views.team_delete, name='team-delete'),
    path('team/deactivate/<int:id>/', views.team_deactivate, name='team-deactivate'),
    path('team/add_member/<int:user_id>/<int:team_id>/', views.team_member_add, name='team-member-add'),
    path('team/remove_member/<int:user_id>/<int:team_id>/', views.team_member_remove, name='team-member-remove'),
    ...
    # mails view
    path('mails/', views.mails_view, name='mails'),
    ...
    path("events/delete/<pk>/", views.EventDelete.as_view(), name="event_delete"),
    ...
    path('start_attendance/<int:event_id>/', views.StartAttendence.as_view(), name='start_attendance'),
