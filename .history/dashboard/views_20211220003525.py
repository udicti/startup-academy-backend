...
def send_email_for_password_reset(user, thread=True, **kwargs):
    ...
    url = f"{current}/add-new-password/{token}/?redirect_url={redirect_url}"
    ...
    email_payload = {
        ...
        "email-body": [
            ...
            f"Your request to reset your password has been received.",
            f"You are required to follow the link below to renew your password. ",
