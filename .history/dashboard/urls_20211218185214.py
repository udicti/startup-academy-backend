...
urlpatterns = [
    ...
    path('team/add_member/<int:user_id>/', views.teams_member_Remove, name='team-member-add'),
    path('team/remove_member/<int:user_id>/', views.teams_remove_member, name='team-member-remove'),
