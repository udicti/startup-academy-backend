...
urlpatterns = [
    ...
    # password issues
    path('forgot-password/', views.ForgotPasswordView.as_view(), name="forgot-password_view"),
    ...
    path('team/add_member/<int:user_id>/', views.team_member_add, name='team-member-add'),
    path('team/remove_member/<int:user_id>/', views.team_member_remove, name='team-member-remove'),
