...
def activate_user(request, id):
    ...
    if one is not None:
        ...
        send_activation_link(one.idef FunctionName(args):
            )
...
def activate_all_inactive_users_users(request):
    
    all_emails = [i.email for i in User.objects.all() if i.is_active == False]
