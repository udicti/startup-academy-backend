...
urlpatterns = [
    ...
    path('team/add_member/<int:user_id>/', views.teams_member_add, name='team-member-add'),
    path('team/remove_member/<int:user_id>/', views.teams_member_remove, name='team-member-remove'),
