...
urlpatterns = [
    ...
    path("send_activation_to_one/", views.send_activation_email_to_all_inactive_users, name="send_activation_to_one"),  
    path("send_activation_to_one/", views.send_activation_email_to_inactive_user, name="send_activation_to_one"),  
