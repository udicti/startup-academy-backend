...
YEAR_OF_STUDY = [(1,"First Year"),(2,"Second Year"), (3,"third Year"), (4,"Fourth Year"), (5,"Fifth Year")]
...
class UserProfile(models.Model):
	...
	year_of_study = models.IntegerField(blank=True, null=True, default=1, choices=YEAR_OF_STUDY)
...
class Attendance(models.Model):
	...
	def save(self, *args, **kwargs):
		...
		code = AttendanceCode(event=self.event)
		code.save()
...
class Teams(models.Model):
    ...
    leader = models.ForeignKey(User, related_name="owned_teams", verbose_name="leader", on_delete=models.CASCADE, default=1)
