...
class AttendanceCode(models.Model):
    ...
    event = models.ForeignKey("api.Event", related_name="event_attendance_codes", verbose_name="event", on_delete=models.CASCADE)
...
class Attendance(models.Model):
	...
	event = models.ForeignKey("api.Event", related_name="event_attendances", verbose_name="event", on_delete=models.CASCADE, null=True)
