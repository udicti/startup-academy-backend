...
from api.serializers import TeamsSerializer, UserSerializer, GroupSerializer, ProjectSerializer,PostLikeSerializer, ProjectLikeSerializer, \
...
from .models import Teams, UserProfile, Project, Mail, BlogPost, Comment, ReviewReply, CommentReply, Review, TopProject, PostLike, ProjectLike
import json
